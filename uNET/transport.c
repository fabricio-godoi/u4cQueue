...
/**
 * TODO: even if the ret_time is set to a value above 10ms, this function
 *       will wait until reach 1 second...
 *
 *       ret_time is meant to be return time or retries time?
 *       This function really need a INFO
 */
